Modifications to this dependencey for this project by Håkan Arnoldson:
* Only two flags used Sweden and UK.
* Rest of dependency not included except this readme to show where flags are from.
